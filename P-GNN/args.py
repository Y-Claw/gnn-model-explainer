...
def make_args():
    ...
    parser.add_argument('--type', dest='type', default='PGNN', type=str,
                        help='PGNN; explainer_train')
    ...
    parser.add_argument('--save', dest='save', default='pred', type=str,
                        help='pred; embedding')

    parser.add_argument('--threshold', dest='threshold', default=0.8, type=int,
                        help='threshold of pred not exit links')

    parser.add_argument('--sp', dest='sp', default=False, type=bool,
                        help='if split the graph to 3 part or not')
    ...
    parser.set_defaults(gpu=True, task='link', model='GCN', dataset='All',
                        ...
                        ckptdir='ckpt', method='base',name_suffix='',clip=2.0,)
